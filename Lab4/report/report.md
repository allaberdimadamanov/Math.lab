...
def main():
    ...
    if a >= 0 and 0 <= b <= a:
        print("Функиция Евклида")
        print(evklidsimply(a,b))
        print("Функция расширенного Евклида")
        print(evklid_extended(a,b))
        print("Функция бинарного Евклида")
        print(binary_evklid(a,b))
        print("Расширенный бинарный Евклид")
...
Мы изучили алгоритм Евклида нахождения НОД в данной лабораторной работе.
